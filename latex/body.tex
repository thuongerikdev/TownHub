...
\textbullet{}  Công cụ: .NET 8, Next.js 16, PostgreSQL, Redis, Cloudinary; AI/OCR: VietOCR, PaddleOCR, Gemini; draw.io, Git.
...
Nhóm đã cùng nhau khảo sát hai nhóm giải pháp phổ biến là quản lý thủ công bằng bảng tính và các phần mềm quản lý bảo trì/tài sản (CMMS/EAM) thương mại, so sánh với hệ thống TownHub đề xuất theo các tiêu chí trải đều ba phân hệ tài sản, dân cư và dịch vụ:

\begin{center}{\singlespacing\renewcommand{\arraystretch}{1.25}
\begin{tabular}{|>{\raggedright\arraybackslash}p{\dimexpr\linewidth/4-2\tabcolsep-\arrayrulewidth\relax}|>{\raggedright\arraybackslash}p{\dimexpr\linewidth/4-2\tabcolsep-\arrayrulewidth\relax}|>{\raggedright\arraybackslash}p{\dimexpr\linewidth/4-2\tabcolsep-\arrayrulewidth\relax}|>{\raggedright\arraybackslash}p{\dimexpr\linewidth/4-2\tabcolsep-\arrayrulewidth\relax}|}
\hline
Tiêu chí & Quản lý thủ công (Excel) & CMMS thương mại & TownHub (đề xuất) \ \hline
...
\textbf{Tài sản – }OCR hóa đơn tự động & Không & Hiếm & Có (VietOCR) \ \hline
\textbf{Tài sản – }Tích hợp kế toán \& chi phí & Thủ công & Tùy sản phẩm & Có (bút toán Nợ/Có) \ \hline
\textbf{Dân cư – }Hồ sơ cư dân \& căn hộ & Rời rạc & Ít hỗ trợ & Có, tập trung \ \hline
\textbf{Dân cư – }Kiểm soát ra vào & Thủ công (thẻ/sổ) & Tùy tích hợp & Có (nhận diện khuôn mặt) \ \hline
\textbf{Dịch vụ – }Kết nối cư dân – NCC dịch vụ & Không & Hiếm & Có (niêm yết dịch vụ) \ \hline
\textbf{Dịch vụ – }Yêu cầu \& phê duyệt, theo dõi & Không & Một phần & Có, có quy trình duyệt \ \hline
\end{tabular}}\end{center}
Các phần mềm thương mại thường mạnh về tài sản – bảo trì nhưng chi phí cao, khó tùy biến theo đặc thù chung cư Việt Nam, ít tích hợp OCR hóa đơn tiếng Việt và gần như không đáp ứng nghiệp vụ dân cư và kết nối dịch vụ nội khu. Quản lý thủ công thì rẻ nhưng rời rạc và dễ sai sót trên cả ba phân hệ. Đây là khoảng trống mà TownHub hướng tới.
...
\begin{figure}[H]\centering
\includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{images/img06.png}
...
\begin{figure}[H]\centering
\includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{images/img07.png}
...
\begin{figure}[H]\centering
\includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{images/img08.png}
...
\begin{figure}[H]\centering
\includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{images/img09.png}
...
\begin{figure}[H]\centering
\includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{images/img12.png}
...
\begin{figure}[H]\centering
\includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{images/img13.png}
...
\begin{figure}[H]\centering
\includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{images/img14.png}
...
\begin{figure}[H]\centering
\includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{images/img15.png}
...
\begin{figure}[H]\centering
\includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{images/img16.png}
...
\begin{figure}[H]\centering
\includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{images/img20.png}
...
\begin{figure}[H]\centering
\includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{images/img21.png}
...
4a. Bố cục lạ hoặc chất lượng ảnh kém: người dùng chọn lại engine \texttt{gemini} để trích bằng mô hình thị giác–ngôn ngữ.\newline
...
\begin{figure}[H]\centering
\includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{images/img22.png}
...
\end{figure}
\begin{figure}[H]\centering
\includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{images/img23.png}
...
Dịch vụ OCR viết bằng Python/FastAPI, tách khỏi backend .NET và gọi qua HTTP POST /extract; chạy bất đồng bộ theo hàng đợi – tiến trình nền (OcrJobQueue $\rightarrow$ OcrProcessingWorker). Dịch vụ hỗ trợ bốn chế độ chọn được trên giao diện (cột ocr\_jobs.ocrEngine), vừa để so sánh mô hình, vừa để chọn engine phù hợp từng loại chứng từ. Ba engine OCR đều quy kết quả về một cấu trúc dòng chuẩn hóa [\{text, box, prob\}] rồi dùng chung một hàm bóc tách trường (regex + luật vị trí), nên thay/đổi engine không ảnh hưởng phần lấy trường.
...
gemini & (mô hình đa thể lo) & Gemini 2.​0 Flash & - (API đóng) & Chính xác cao, phụ thuộc API và chi phí \ \hline
\end{tabular}}\end{center}
\begin{figure}[H]\centering
\includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{images/img27.png}
\caption*{\small Hình 4.16. Kiến trúc pipeline trích xuất hóa đơn (dịch vụ OCR bốn engine)}
\addcontentsline{lof}{figure}{Hình 4.16. Kiến trúc pipeline trích xuất hóa đơn (dịch vụ OCR bốn engine)}
\end{figure}
...
\textbf{EasyOCR và Gemini. }Pipeline vietocr chỉ mượn bộ phát hiện CRAFT của EasyOCR để cắt dòng (nhận dạng giao cho VietOCR). Gemini 2.0 Flash là mô hình ngôn ngữ – thị giác, nhận thẳng ảnh và trả về JSON các trường; chính xác cao nhưng phụ thuộc API và chi phí nên giữ làm tùy chọn.
...
\noindent\textit{(3) EasyOCR/CRAFT và Gemini.}
Pipeline \texttt{vietocr} chỉ mượn bộ phát hiện \emph{CRAFT} của EasyOCR để định vị và cắt dòng (CRAFT dự đoán bản đồ vùng ký tự và bản đồ liên kết giữa các ký tự để gom thành từ/dòng), phần nhận dạng giao cho VietOCR. Vì CRAFT \emph{không được fine-tune} trên dữ liệu hóa đơn nên trở thành nút cổ chai của pipeline này. Gemini~2.0 Flash là mô hình thị giác–ngôn ngữ (VLM): nhận thẳng ảnh và một chỉ dẫn (prompt) yêu cầu trả về JSON các trường; độ chính xác cao với bố cục lạ nhưng phụ thuộc API bên ngoài và chi phí, nên được giữ làm phương án dự phòng.
...
\begin{figure}[H]\centering
\includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{images/img35.png}
...
Quy trình: Báo sự cố (tạo ticket) $\rightarrow$ tiếp nhận \& phân công KTV (TicketAssignment) $\rightarrow$ KTV xử lý, cập nhật trạng thái, xuất vật tư/tạo PR nếu thiếu, chụp ảnh trước/sau (TicketAttachment) $\rightarrow$ đóng sự cố khi khắc phục xong. Luồng xử lý sự cố và giám sát SLA được minh họa ở Hình 4.25.

\begin{figure}[H]\centering
\includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{images/img36.png}
\caption*{\small Hình 4.25. Lưu đồ nghiệp vụ: Xử lý sự cố và giám sát SLA}
\addcontentsline{lof}{figure}{Hình 4.25. Lưu đồ nghiệp vụ: Xử lý sự cố và giám sát SLA}
\end{figure}
...
\subsubsection*{a) Danh sách Use Case chính}
Các use case chính của phân hệ được thể hiện trên biểu đồ use case ở Hình 4.26 và liệt kê trong bảng dưới đây.

\begin{figure}[H]\centering
\includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{images/img37.png}
\caption*{\small Hình 4.26. Biểu đồ Use Case – Quản lý sự cố và SLA}
\addcontentsline{lof}{figure}{Hình 4.26. Biểu đồ Use Case – Quản lý sự cố và SLA}
\end{figure}
\begin{center}{\singlespacing\renewcommand{\arraystretch}{1.25}
\begin{tabular}{|>{\raggedright\arraybackslash}p{\dimexpr\linewidth/3-2\tabcolsep-\arrayrulewidth\relax}|>{\raggedright\arraybackslash}p{\dimexpr\linewidth/3-2\tabcolsep-\arrayrulewidth\relax}|>{\raggedright\arraybackslash}p{\dimexpr\linewidth/3-2\tabcolsep-\arrayrulewidth\relax}|}
\hline
...
Vòng đời trạng thái của một ticket sự cố được thể hiện ở Hình 4.27, trong đó trạng thái "Đang xử lý" có thể chuyển sang "Chờ vật tư" khi thiếu vật tư và quay lại khi đã có.

\begin{figure}[H]\centering
\includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{images/img38.png}
\caption*{\small Hình 4.27. Sơ đồ trạng thái vòng đời ticket sự cố}
\addcontentsline{lof}{figure}{Hình 4.27. Sơ đồ trạng thái vòng đời ticket sự cố}
\end{figure}
\begin{figure}[H]\centering
\includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{images/img39.png}
\caption*{\small Hình 4.28. Sơ đồ thực thể – liên kết (ERD) phân hệ Quản lý sự cố \& SLA}
\addcontentsline{lof}{figure}{Hình 4.28. Sơ đồ thực thể – liên kết (ERD) phân hệ Quản lý sự cố \& SLA}
\end{figure}
...
\caption*{\small Hình 4.29. Giao diện Danh sách phiếu sự cố (CM)}
\addcontentsline{lof}{figure}{Hình 4.29. Giao diện Danh sách phiếu sự cố (CM)}
\end{figure}
\begin{figure}[H]\centering
\includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{images/img41.png}
\caption*{\small Hình 4.30. Giao diện Bảng theo dõi SLA}
\addcontentsline{lof}{figure}{Hình 4.30. Giao diện Bảng theo dõi SLA}
\end{figure}
\phantomsection
